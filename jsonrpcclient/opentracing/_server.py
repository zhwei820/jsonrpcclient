...
from jsonrpcclient.opentracing import ActiveSpanSource
...
class _OpenTracingServicerContext(ActiveSpanSource):
    ...
    def __init__(self, servicer_context, active_span):
        ...
        self.code = jsonrpc.StatusCode.OK
        self.details = None
...
def _check_error_code(span, servicer_context, rpc_info):
    if servicer_context.code != jsonrpc.StatusCode.OK:
...
class OpenTracingServerInterceptor(jsonrpcext.UnaryServerInterceptor,
                                   jsonrpcext.StreamServerInterceptor):
